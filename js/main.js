...
const theBadge = document.querySelector("#newBadge");
...
//svgGraphic.addEventListener("click", logID);
    ...
    // Select element you want to interact with first


const mBadge = document.querySelector("#mainBadge");

function logID() {
    console.log(this.id);
}

mBadge.addEventListener('click',logID);